# APIICAM Sarl - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **APIICAM Sarl**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@apiicamsarl.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@apiicamsarl.cm` | `user123` | |
...
*   **Contact :** contact@apiicamsarl.cm